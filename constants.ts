...
export const TEXT = {
  [Lang.CN]: {
    ...
    roomQrTitle: '房间二维码',
    scanToJoin: '扫码加入房间',
    connectionNotReady: '连接未就绪，请稍候',
    roomNotFound: '房间不存在',
    roomEnded: '房间已结束',
    connectionFailed: '连接失败，请刷新重试',
  ...
  [Lang.EN]: {
    ...
    connectionNotReady: 'Connection not ready, please wait',
    roomNotFound: 'Room not found',
    roomEnded: 'Room ended',
    connectionFailed: 'Connection failed, please refresh and try again',
